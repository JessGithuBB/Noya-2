 ...
 */
final class Version20250807151204 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE category ADD parent_id INT DEFAULT NULL, DROP slug, DROP created_at, DROP updated_at
        SQL);
        $this->addSql(<<<'SQL'
    ...
    public function down(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            DROP INDEX IDX_64C19C1727ACA70 ON category
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE category ADD slug VARCHAR(255) NOT NULL, ADD created_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', ADD updated_at DATETIME DEFAULT NULL COMMENT '(DC2Type:datetime_immutable)', DROP parent_id
        SQL);
        $this->addSql(<<<'SQL'
